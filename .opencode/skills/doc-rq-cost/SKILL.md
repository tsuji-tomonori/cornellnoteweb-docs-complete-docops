---
name: doc-rq-cost
description: RQ-COST（非機能要求）ドキュメントを、規約どおりに新規作成/更新する。使う場面: RQ-COST の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: RQ-COST を規約どおりに新規作成/更新
---

## 目的
非機能要求（COST）を SnowCard で定義し、設計と運用に落とす。
