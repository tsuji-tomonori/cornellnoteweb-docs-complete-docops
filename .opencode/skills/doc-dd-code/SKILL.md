---
name: doc-dd-code
description: DD-CODE（コーディング規約）ドキュメントを、規約どおりに新規作成/更新する。使う場面: DD-CODE の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: DD-CODE を規約どおりに新規作成/更新
---

## 目的
開発規約（CODE）を定義し、品質と一貫性を担保する。
