---
name: doc-ut-stat
description: UT-STAT（静的解析）ドキュメントを、規約どおりに新規作成/更新する。使う場面: UT-STAT の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: UT-STAT を規約どおりに新規作成/更新
---
