---
name: doc-it-tdat
description: IT-TDAT（テストデータ設計）ドキュメントを、規約どおりに新規作成/更新する。使う場面: IT-TDAT の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: IT-TDAT を規約どおりに新規作成/更新
---
