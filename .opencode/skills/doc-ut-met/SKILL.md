---
name: doc-ut-met
description: UT-MET（品質メトリクス）ドキュメントを、規約どおりに新規作成/更新する。使う場面: UT-MET の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: UT-MET を規約どおりに新規作成/更新
---
