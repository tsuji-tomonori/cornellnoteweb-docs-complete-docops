---
name: doc-it-case
description: IT-CASE（結合テストケース）ドキュメントを、規約どおりに新規作成/更新する。使う場面: IT-CASE の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: IT-CASE を規約どおりに新規作成/更新
---

## 目的
ITのテストケース/シナリオを、再現可能な手順と期待結果で定義する（1ケース=1ファイル）。
