---
name: doc-it-plan
description: IT-PLAN（結合テスト計画）ドキュメントを、規約どおりに新規作成/更新する。使う場面: IT-PLAN の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: IT-PLAN を規約どおりに新規作成/更新
---

## 目的
ITの計画を定義し、範囲/観点/環境/完了条件を明確にする。
