---
name: doc-dd-scale
description: DD-SCALE（拡張性）ドキュメントを、規約どおりに新規作成/更新する。使う場面: DD-SCALE の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: DD-SCALE を規約どおりに新規作成/更新
---

## 目的
品質特性（SCALE）を詳細設計に落とし込む。
...
- `tags`（例: `DD`, `SCALE`, `CornellNoteWeb`）

## 典型リンク（ドキュメント種別）
- 上位（up）: BD-QUAL / RQ-PS / RQ-AV
- 下位（Backlink）: UT-PLAN / IT-PLAN / BD-MON
- 関連（related）: （なし）
