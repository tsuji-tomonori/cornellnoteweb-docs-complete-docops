---
name: doc-bd-erd
description: BD-ERD（データアーキテクチャ）ドキュメントを、規約どおりに新規作成/更新する。使う場面: BD-ERD の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: BD-ERD を規約どおりに新規作成/更新
---
