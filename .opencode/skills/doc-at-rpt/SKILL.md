---
name: doc-at-rpt
description: AT-RPT（受入テスト報告）ドキュメントを、規約どおりに新規作成/更新する。使う場面: AT-RPT の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: AT-RPT を規約どおりに新規作成/更新
---
