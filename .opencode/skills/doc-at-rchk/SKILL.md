---
name: doc-at-rchk
description: AT-RCHK（リリースチェックリスト）ドキュメントを、規約どおりに新規作成/更新する。使う場面: AT-RCHK の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: AT-RCHK を規約どおりに新規作成/更新
---
