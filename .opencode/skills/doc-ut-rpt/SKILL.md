---
name: doc-ut-rpt
description: UT-RPT（単体テストレポート）ドキュメントを、規約どおりに新規作成/更新する。使う場面: UT-RPT の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: UT-RPT を規約どおりに新規作成/更新
---
