---
name: doc-rq-data
description: RQ-DATA（非機能要求）ドキュメントを、規約どおりに新規作成/更新する。使う場面: RQ-DATA の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: RQ-DATA を規約どおりに新規作成/更新
---

## 目的
非機能要求（DATA）を SnowCard で定義し、設計と運用に落とす。
