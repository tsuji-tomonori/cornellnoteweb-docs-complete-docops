---
name: doc-bd-ret
description: BD-RET（データアーキテクチャ（保持））ドキュメントを、規約どおりに新規作成/更新する。使う場面: BD-RET の新規作成、内容更新、リンク整合の修正依頼時。
metadata:
  short-description: BD-RET を規約どおりに新規作成/更新
---
